...
(lib.jack = function() {
	this.initialize(img.jack);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,800,600);


(lib.jackfruit = function() {
	this.initialize(img.jackfruit);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,272,185);


(lib.Pineapplepngcopy = function() {
	this.initialize(img.Pineapplepngcopy);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-98,46,0.3373,0.3373);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-98,46,269.9,202.4), null);
...
(lib.Slotcopy3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-185,-39,0.3355,0.3355);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slotcopy3, new cjs.Rectangle(-185,-39,268.4,201.3), null);
...
(lib.Slotcopy = function(mode,startPosition,loop) {
	...
	this.shape.graphics.bf(img.jack, null, new cjs.Matrix2D(1,0,0,1,-396.5,-264.8)).s().p("AwBMRQmolFAAnMQAAnLGolGQGplEJYgBQJZABGpFEQGoFGAAHLQAAHMmoFFQmpFFpZABQpYgBmplFg");
	this.shape.setTransform(51.7747,106.7667,0.8507,0.8507);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slotcopy, new cjs.Rectangle(-71.6,12.3,246.79999999999998,189), null);
...
p.nominalBounds = new cjs.Rectangle(-48,-47,96,96);
...
(lib.RoundedSquarePiece = function(mode,startPosition,loop) {
	...
	// Rec
	this.instance = new lib.jackfruit();
	this.instance.setTransform(-104,-38,0.5595,0.5595);
...
p.nominalBounds = new cjs.Rectangle(-104,-38,152.2,103.5);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.slot1.setTransform(563.7,413.4,1,1,0,0,0,23.5,135.8);
...
}).prototype = getMCSymbolPrototype(lib.Slots, new cjs.Rectangle(139.9,323.6,885.1,221.60000000000002), null);
...
(lib.StarPiece = function(mode,startPosition,loop) {
	...
	// Icon
	this.instance = new lib.Pineapplepngcopy();
	this.instance.setTransform(-67,-61,1.3865,1.25);
...
p.nominalBounds = new cjs.Rectangle(-67,-61,133.1,120);
...
}).prototype = getMCSymbolPrototype(lib.Pieces, new cjs.Rectangle(183.3,145.3,685.3,120), null);
...
}).prototype = getMCSymbolPrototype(lib.Game, new cjs.Rectangle(30.3,22.3,1090.2,551.6), null);


// stage content:
(lib.tree7 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/jack.png", id:"jack"},
		{src:"images/jackfruit.png", id:"jackfruit"},
		{src:"images/Pineapplepngcopy.png", id:"Pineapplepngcopy"},
