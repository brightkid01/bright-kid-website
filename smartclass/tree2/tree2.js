...
(lib.Bananapngcopy = function() {
	this.initialize(img.Bananapngcopy);
}).prototype = p = new cjs.Bitmap();
...
(lib.Orangepngcopy = function() {
	this.initialize(img.Orangepngcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,96,96);
...
(lib.watermelonpngcopy = function() {
	this.initialize(img.watermelonpngcopy);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-39,43,0.2851,0.2852);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-39,43,156.8,209.1), null);
...
(lib.Slotcopy3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-193,-29,0.2479,0.248);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slotcopy3, new cjs.Rectangle(-193,-29,198.4,148.8), null);
...
(lib.Slotcopy = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-67,18,0.2841,0.2842);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slotcopy, new cjs.Rectangle(-67,18,227.3,170.5), null);
...
(lib.SquarePiece = function(mode,startPosition,loop) {
	...
	// Rec
	this.instance = new lib.Bananapngcopy();
	this.instance.setTransform(-81,-48,1.375,1.375);
...
p.nominalBounds = new cjs.Rectangle(-81,-48,132,132);
...
(lib.RoundedSquarePiece = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.watermelonpngcopy();
	this.instance.setTransform(-48,-24);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Rec
	this.instance_1 = new lib.watermelon();
...
p.nominalBounds = new cjs.Rectangle(-48,-24,96,96);
...
}).prototype = getMCSymbolPrototype(lib.Slots, new cjs.Rectangle(163.8,339.9,783.2,209), null);
...
(lib.StarPiece = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.Orangepngcopy();
	this.instance.setTransform(-98,-38);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Icon
	this.instance_1 = new lib.Orange();
	this.instance_1.setTransform(-98,-38);

	this.instance_2 = new lib.StarIcon("single",0);
...
p.nominalBounds = new cjs.Rectangle(-98,-38,96,96);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.piece0.setTransform(525.2,202.25,1,1,0,0,0,-49,10);
...
}).prototype = getMCSymbolPrototype(lib.Pieces, new cjs.Rectangle(163.7,144.3,704.7,132), null);
...
}).prototype = getMCSymbolPrototype(lib.Game, new cjs.Rectangle(30.5,22.3,1090,555.2), null);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Bananapngcopy.png", id:"Bananapngcopy"},
		{src:"images/BRIGHTEDGELOGO.jpg", id:"BRIGHTEDGELOGO"},
		{src:"images/Orange.png", id:"Orange"},
		{src:"images/Orangepngcopy.png", id:"Orangepngcopy"},
		{src:"images/watermelon.png", id:"watermelon"},
		{src:"images/watermelonpngcopy.png", id:"watermelonpngcopy"},
