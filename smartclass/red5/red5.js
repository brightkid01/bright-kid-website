...
(lib.StarIcon = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#050505").s().p("");
	this.shape.setTransform(-2,2.2909);
...
p.nominalBounds = new cjs.Rectangle(-55.6,-61.1,106.1,121);
...
p.nominalBounds = new cjs.Rectangle(-56.6,-61.1,113.2,121);
...
(lib.SquarePiece = function(mode,startPosition,loop) {
	...
	// Rec
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#373535").s().p("");
	this.shape.setTransform(5.75,2.25);
...
(lib.RoundedSquarePiece = function(mode,startPosition,loop) {
	...
	// Icon
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#373535").s().p("Ag9CdQgWgFgNgIQgMAAgIgIQgHgHAAgLIACg7IABg7IAAhAIgBhBQAAgKAKgLQAKgLAMAAQAHAAAZAMIAkARQA5ASAoAnQAwAuAAA3QAAAigQAfQgRAfgdASQggAWg6AAQgOAAgTgFgAhEBjQAIAFAKADQAKACAMAAQApAAASgMQASgLAKgTQAKgTAAgVQAAgvg4gkQgSgLg/gag");
	this.shape.setTransform(-2.075,1.825);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.slot1.setTransform(633.6,343.15);

	this.slot0 = new lib.Slot();
	this.slot0.name = "slot0";
	this.slot0.setTransform(447.5,343.15);

	this.slot2 = new lib.Slot();
	this.slot2.name = "slot2";
	this.slot2.setTransform(258.5,343.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.slot2},{t:this.slot0},{t:this.slot1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slots, new cjs.Rectangle(189.6,274.2,513,137.90000000000003), null);
...
}).prototype = getMCSymbolPrototype(lib.Pieces, new cjs.Rectangle(199.1,131.2,575.5,121), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(121.1129,29.9745,0.373,0.373);
	...
	this.shape_1.setTransform(59.9429,46.2419,0.3727,0.3727);
	...
	this.shape_2.setTransform(60.0784,47.4107,0.373,0.373);
	...
	this.shape_3.setTransform(52.281,48.4187,0.373,0.373);
	...
	this.shape_4.setTransform(52.2735,48.3907,0.373,0.373);
	...
	this.shape_5.setTransform(50.1053,43.0966,0.373,0.373);
	...
	this.shape_6.setTransform(50.0992,43.1245,0.373,0.373);
	...
	this.shape_7.setTransform(49.304,45.1986,0.3727,0.3727);
	...
	this.shape_8.setTransform(49.3753,46.2818,0.373,0.373);
	...
	this.shape_9.setTransform(52.4412,48.5772,0.373,0.373);
	...
	this.shape_10.setTransform(52.432,48.5399,0.373,0.373);
	...
	this.shape_11.setTransform(50.2535,43.2551,0.373,0.373);
	...
	this.shape_12.setTransform(50.2497,43.2737,0.373,0.373);
	...
	this.shape_13.setTransform(49.5501,46.5357,0.373,0.373);
	...
	this.shape_14.setTransform(49.5314,46.4491,0.373,0.373);
	...
	this.shape_26.setTransform(119.3878,36.2174,0.373,0.373);
	...
	this.shape_52.setTransform(118.8936,35.8491,0.373,0.373);
	...
	this.shape_60.setTransform(118.875,35.5236,0.373,0.373);
	...
	this.shape_61.setTransform(118.875,35.5236,0.373,0.373);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#CB7246").s().p("AgFAAQAAgEAFgBQAGgBAAAGQAAAGgGAAQgFABAAgHg");
	this.shape_62.setTransform(115.4994,36.7536,0.373,0.373);
	...
	this.shape_63.setTransform(116.4534,42.9638,0.373,0.373);
	...
	this.shape_70.setTransform(117.3995,41.4275,0.373,0.373);
	...
	this.shape_71.setTransform(117.3975,41.4066,0.373,0.373);
	...
	this.shape_72.setTransform(115.3145,40.9776,0.373,0.373);
	...
	this.shape_73.setTransform(114.2552,46.4655,0.373,0.373);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f().s("#EE3338").ss(0.2,0,0,2.6).p("Ag1AHIAlgKQAqgIAbAO");
	this.shape_74.setTransform(71.6181,33.6682,0.373,0.373);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#373535").s().p("AgCAmIgLgDIAXhQIAEBbQgFgFgLgDg");
	this.shape_75.setTransform(105.3542,34.525,0.373,0.373);
	...
	this.shape_76.setTransform(103.2111,40.8471,0.373,0.373);
	...
	this.shape_77.setTransform(102.6233,47.5028,0.373,0.373);
	...
	this.shape_78.setTransform(97.9609,44.9437,0.373,0.373);
	...
	this.shape_87.setTransform(96.2161,50.8693,0.373,0.373);
	...
	this.shape_88.setTransform(99.9739,36.8571,0.373,0.373);
	...
	this.shape_89.setTransform(97.7919,43.8869,0.373,0.373);
	...
	this.shape_90.setTransform(97.7826,43.8683,0.373,0.373);
	...
	this.shape_91.setTransform(96.1415,50.8711,0.373,0.373);
	...
	this.shape_92.setTransform(96.1423,50.8701,0.373,0.373);
	...
	this.shape_106.setTransform(72.5128,35.0378,0.373,0.373);
	...
	this.shape_114.setTransform(71.6258,34.6969,0.373,0.373);
	...
	this.shape_115.setTransform(71.484,34.1857,0.3727,0.3727);
	...
	this.shape_116.setTransform(71.6083,35.3549,0.373,0.373);
	...
	this.shape_117.setTransform(88.1223,45.183,0.373,0.373);
	...
	this.shape_118.setTransform(88.1036,45.2017,0.373,0.373);
	...
	this.shape_119.setTransform(80.4947,47.2251,0.373,0.373);
	...
	this.shape_120.setTransform(80.494,47.2335,0.373,0.373);
	...
	this.shape_121.setTransform(107.9838,41.4998,0.373,0.373);
	...
	this.shape_122.setTransform(107.9744,41.4998,0.373,0.373);
	...
	this.shape_123.setTransform(108.1143,47.5142,0.373,0.373);
	...
	this.shape_124.setTransform(108.1143,47.5328,0.373,0.373);
	...
	this.shape_125.setTransform(65.7618,41.4998,0.373,0.373);
	...
	this.shape_126.setTransform(65.7524,41.4998,0.373,0.373);
	...
	this.shape_127.setTransform(65.8923,47.5142,0.373,0.373);
	...
	this.shape_140.setTransform(75.7676,47.0213,0.373,0.373);
	...
	this.shape_141.setTransform(68.0458,46.5068,0.373,0.373);
	...
	this.shape_142.setTransform(69.1838,37.9005,0.373,0.373);
	...
	this.shape_143.setTransform(68.2004,35.2473,0.373,0.373);
	...
	this.shape_144.setTransform(68.1818,35.2561,0.373,0.373);
	...
	this.shape_145.setTransform(71.6184,39.6628,0.373,0.373);
	...
	this.shape_146.setTransform(71.6162,39.6349,0.373,0.373);
	...
	this.shape_147.setTransform(73.7637,38.3792,0.373,0.373);
	...
	this.shape_148.setTransform(74.457,40.262,0.373,0.373);
	...
	this.shape_149.setTransform(74.457,40.2806,0.373,0.373);

	this.shape_150 = new cjs.Shape();
	this.shape_150.graphics.f("#00B0F0").s().p("AgIAZIgPgEIAIgrIAmgDIABAxQgKACgKAAIgMgBg");
	this.shape_150.setTransform(71.6083,38.3891,0.373,0.373);
	...
	this.shape_151.setTransform(71.7298,44.3665,0.373,0.373);
	...
	this.shape_152.setTransform(72.3729,47.9525,0.373,0.373);
	...
	this.shape_153.setTransform(72.2573,47.5184,0.3727,0.3727);

	this.shape_154 = new cjs.Shape();
	this.shape_154.graphics.f("#EE3338").s().p("AglgDIAqglIAhBRg");
	this.shape_154.setTransform(55.1037,54.2093,0.373,0.373);

	this.shape_155 = new cjs.Shape();
	this.shape_155.graphics.f("#EE3338").s().p("AgagjIA1gIIgNBXg");
	this.shape_155.setTransform(50.3388,56.298,0.373,0.373);

	this.shape_156 = new cjs.Shape();
	this.shape_156.graphics.f("#DE3438").s().p("AgoADIBRgwIgmBbg");
	this.shape_156.setTransform(56.3066,39.7561,0.373,0.373);

	this.shape_157 = new cjs.Shape();
	this.shape_157.graphics.f("#EE3338").s().p("AgdApIAkhZIAXBhg");
	this.shape_157.setTransform(50.9449,36.5671,0.373,0.373);

	this.shape_158 = new cjs.Shape();
	this.shape_158.graphics.f("#F26C36").s().p("AgZhhIAzALIgyC4g");
	this.shape_158.setTransform(47.9703,57.9765,0.373,0.373);

	this.shape_159 = new cjs.Shape();
	this.shape_159.graphics.f("#F26C36").s().p("AgjhfIBHC0Ig0ALg");
	this.shape_159.setTransform(47.8491,35.1404,0.373,0.373);

	this.shape_160 = new cjs.Shape();
	this.shape_160.graphics.f("#F26C36").s().p("Ag3g9IAhgZIBOCsg");
	this.shape_160.setTransform(54.0034,57.044,0.373,0.373);

	this.shape_161 = new cjs.Shape();
	this.shape_161.graphics.f("#F26C36").s().p("Ag2BDIBtiYIhJCrg");
	this.shape_161.setTransform(54.74,36.1568,0.373,0.373);

	this.shape_162 = new cjs.Shape();
	this.shape_162.graphics.f("#373535").s().p("AhQAAICfgYIAAANQAAARACATg");
	this.shape_162.setTransform(39.1492,47.0573,0.373,0.373);
	...
	this.shape_163.setTransform(60.2556,47.6074,0.373,0.373);
	...
	this.shape_164.setTransform(60.2748,47.5972,0.373,0.373);
	...
	this.shape_165.setTransform(52.4431,48.6337,0.373,0.373);
	...
	this.shape_166.setTransform(52.4693,48.5772,0.373,0.373);
	...
	this.shape_167.setTransform(50.2966,43.6292,0.373,0.373);
	...
	this.shape_168.setTransform(50.2966,43.3016,0.373,0.373);
	...
	this.shape_169.setTransform(49.6221,46.4683,0.373,0.373);
	...
	this.shape_202.setTransform(119.091,36.0356,0.373,0.373);
	...
	this.shape_203.setTransform(118.0544,36.1102,0.373,0.373);

	this.shape_204 = new cjs.Shape();
	this.shape_204.graphics.f().s("#201F1F").ss(0.2,0,0,2.6).p("AACgGQACAAABADQACACgBACQgCAIgEgBQgGgBACgHQACgIAEACg");
	this.shape_204.setTransform(117.894,36.026,0.373,0.373);
	...
	this.shape_205.setTransform(117.894,36.026,0.373,0.373);
	...
	this.shape_206.setTransform(117.9798,35.71,0.373,0.373);
	...
	this.shape_209.setTransform(118.9496,35.9462,0.373,0.373);

	this.shape_210 = new cjs.Shape();
	this.shape_210.graphics.f("#373535").s().p("AgFAAQgBgEAGgCQAFAAABAGQAAAGgGABQgFgBAAgGg");
	this.shape_210.setTransform(115.7019,36.9401,0.373,0.373);
	...
	this.shape_211.setTransform(116.6528,43.1506,0.373,0.373);
	...
	this.shape_218.setTransform(117.3691,40.3601,0.3727,0.3727);
	...
	this.shape_219.setTransform(117.5373,41.5091,0.373,0.373);
	...
	this.shape_220.setTransform(115.5088,41.1641,0.373,0.373);
	...
	this.shape_225.setTransform(103.404,41.0336,0.373,0.373);
	...
	this.shape_226.setTransform(102.4001,47.5713,0.373,0.373);
	...
	this.shape_227.setTransform(98.1569,45.1302,0.373,0.373);
	...
	this.shape_232.setTransform(96.1706,51.0465,0.373,0.373);
	...
	this.shape_233.setTransform(100.1511,36.8665,0.373,0.373);
	...
	this.shape_234.setTransform(97.9691,44.0641,0.373,0.373);
	...
	this.shape_235.setTransform(97.9784,44.0548,0.373,0.373);
	...
	this.shape_236.setTransform(96.2907,51.036,0.373,0.373);
	...
	this.shape_237.setTransform(96.3288,51.1084,0.373,0.373);
	...
	this.shape_238.setTransform(100.1884,36.9446,0.373,0.373);
	...
	this.shape_239.setTransform(100.1149,36.8328,0.373,0.373);

	this.shape_240 = new cjs.Shape();
	this.shape_240.graphics.f().s("#EE3338").ss(0.5,0,0,2.6).p("AAEAFQgFgFAAgFQAAABAAAAIgCAHIAFAGg");
	this.shape_240.setTransform(98.5336,44.8351,0.373,0.373);

	this.shape_241 = new cjs.Shape();
	this.shape_241.graphics.f("#373535").s().p("AgDABIACgHIAAgBQAAAFAFAFIgCAEg");
	this.shape_241.setTransform(98.5286,44.9033,0.373,0.373);
	...
	this.shape_242.setTransform(88.3181,45.3695,0.373,0.373);
	...
	this.shape_243.setTransform(88.3088,45.3789,0.373,0.373);
	...
	this.shape_244.setTransform(80.6905,47.4116,0.373,0.373);
	...
	this.shape_245.setTransform(80.6991,47.42,0.373,0.373);
	...
	this.shape_246.setTransform(108.1796,41.6863,0.373,0.373);
	...
	this.shape_247.setTransform(108.1703,41.6863,0.373,0.373);
	...
	this.shape_248.setTransform(108.3101,47.7007,0.373,0.373);
	...
	this.shape_249.setTransform(108.3101,47.71,0.373,0.373);
	...
	this.shape_250.setTransform(65.8379,40.512,0.3727,0.3727);
	...
	this.shape_251.setTransform(65.9576,41.6863,0.373,0.373);
	...
	this.shape_252.setTransform(66.0881,47.7007,0.373,0.373);
	...
	this.shape_258.setTransform(72.5781,48.139,0.373,0.373);
	...
	this.shape_259.setTransform(72.453,47.7047,0.3727,0.3727);

	this.shape_260 = new cjs.Shape();
	this.shape_260.graphics.f("#373535").s().p("AgkgDIAogjIAgBNg");
	this.shape_260.setTransform(55.2342,54.3492,0.373,0.373);

	this.shape_261 = new cjs.Shape();
	this.shape_261.graphics.f("#373535").s().p("AgZgkIAzgHIgNBXg");
	this.shape_261.setTransform(50.4227,56.4752,0.373,0.373);

	this.shape_262 = new cjs.Shape();
	this.shape_262.graphics.f("#373535").s().p("AgoADIBRgxIglBdg");
	this.shape_262.setTransform(56.3252,39.9426,0.373,0.373);

	this.shape_263 = new cjs.Shape();
	this.shape_263.graphics.f("#373535").s().p("AgdAqIAkhaIAXBhg");
	this.shape_263.setTransform(51.0661,36.7442,0.373,0.373);

	this.shape_264 = new cjs.Shape();
	this.shape_264.graphics.f("#373535").s().p("AgahhIA0ALIgyC4g");
	this.shape_264.setTransform(47.9797,58.1536,0.373,0.373);

	this.shape_265 = new cjs.Shape();
	this.shape_265.graphics.f("#373535").s().p("AgjhfIBHC0Ig0AKg");
	this.shape_265.setTransform(48.017,35.3176,0.373,0.373);

	this.shape_266 = new cjs.Shape();
	this.shape_266.graphics.f("#373535").s().p("Ag2g9IAggZIBNCtg");
	this.shape_266.setTransform(54.1526,57.2491,0.373,0.373);

	this.shape_267 = new cjs.Shape();
	this.shape_267.graphics.f("#373535").s().p("Ag2BDIBtiYIhJCrg");
	this.shape_267.setTransform(54.74,36.3433,0.373,0.373);
	...
	this.shape_268.setTransform(99.4331,56.5591,0.373,0.373);
	...
	this.shape_269.setTransform(99.4424,56.5405,0.373,0.373);
	...
	this.shape_270.setTransform(78.8072,54.9627,0.3727,0.3727);
	...
	this.shape_271.setTransform(78.9468,56.1488,0.373,0.373);
	...
	this.shape_272.setTransform(105.2237,63.6343,0.373,0.373);
	...
	this.shape_273.setTransform(68.3633,62.2658,0.373,0.373);
	...
	this.shape_274.setTransform(80.4749,48.299,0.373,0.373);
	...
	this.shape_275.setTransform(80.6394,48.4692,0.373,0.373);
	...
	this.shape_276.setTransform(80.6532,48.2788,0.373,0.373);

	this.shape_277 = new cjs.Shape();
	this.shape_277.graphics.f("#000000").s().p("AgJAJQgEgEAAgEQAAgEAEgEQAEgEAFAAQAGAAAEAEQAEADAAAFQAAAEgEAEQgEADgGAAQgFAAgEgDg");
	this.shape_277.setTransform(672.925,45.65);

	this.shape_278 = new cjs.Shape();
	this.shape_278.graphics.f("#000000").s().p("AAYBCQgGAEgGABIgMABQgUAAgNgNQgNgNAAgTQAAgYANgOQANgOAVAAQAGAAAGACIAJADQABgeABgKQACgLAKAAQAFAAADADQADAEAAAFIgCAmIgCAlQAAAgACAKIABADQAAAEgEAEQgDADgFAAQgHAAgDgGgAgRAEQgHAHAAAPQAAAKAHAGQAHAIAKgBQAFAAAEgBIAIgGIADgCIAAghQgDgFgFgCQgEgCgHgBQgMABgGAGg");
	this.shape_278.setTransform(663.675,39.15);

	this.shape_279 = new cjs.Shape();
	this.shape_279.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGAAAPQABAJgLAIQgFADgPAGIgcAMQADAFAHADQAFABAHAAQAMAAAIgEQAIgEAEgBQAJAAAAAJQAAALgPAGQgMAFgOAAQgTAAgOgKgAgLgUQgGAGgDAKIAUgIIASgKQgHgDgJgBQgIABgFAFg");
	this.shape_279.setTransform(653.35,41.55);

	this.shape_280 = new cjs.Shape();
	this.shape_280.graphics.f("#000000").s().p("AgvBCQgEgEAAgFIABgTIAAgUIAAhGQAAgGADgEQAFgGAIAAIAWACQAMABAHAFQAmATAAAcQAAALgIAIQgIAJgPAGQAXANAMANQADAEAAAEQAAAFgEAEQgEADgFAAQgFAAgDgDQgbgZgfgKIABAcQAAAFgEAEQgDADgFAAQgGAAgDgDgAgaADIADAAQAWAAAJgFQAFgCAEgEQADgDAAgCQAAgKgMgJQgLgJgNgBIgKgBg");
	this.shape_280.setTransform(642.925,39.3481);

	this.shape_281 = new cjs.Shape();
	this.shape_281.graphics.f("#000000").s().p("AAYBCQgGAEgGABIgMABQgUAAgNgNQgNgNAAgTQAAgYANgOQANgOAVAAQAGAAAGACIAJADQABgeABgKQACgLAKAAQAFAAADADQADAEAAAFIgCAmIgCAlQAAAgACAKIABADQAAAEgEAEQgDADgFAAQgHAAgDgGgAgRAEQgHAHAAAPQAAAKAHAGQAHAIAKgBQAFAAAEgBIAIgGIADgCIAAghQgDgFgFgCQgEgCgHgBQgMABgGAGg");
	this.shape_281.setTransform(615.975,39.15);

	this.shape_282 = new cjs.Shape();
	this.shape_282.graphics.f("#000000").s().p("AgiAuQgDgEABgEIAAg5IAAgIIAAgIQAAgFACgDQADgEAGAAQAJAAACAKQAPgLATAAQARAAAAAXIAAAGQAAANgLAAQgLAAAAgLIgBgJQgTADgJARIAAAsQAAAFgDADQgDADgGAAQgFAAgDgDg");
	this.shape_282.setTransform(606.65,41.625);

	this.shape_283 = new cjs.Shape();
	this.shape_283.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_283.setTransform(597.396,41.65);

	this.shape_284 = new cjs.Shape();
	this.shape_284.graphics.f("#000000").s().p("AADAcQgDgIgCgVIgCAEIgNAiQgBAEgDACQgEAGgHAAQgEAAgFgHQgEgIgDgMQgDgLgGgkIgBgMQAAgFADgDQAEgDAFAAQAJAAACAJIADAMIABANIADAVIAQgrQADgMAJAAQAKAAADANIAEAXIAFAYIANg1QACgHAKAAQAEAAAFADQADADAAAFIAAADIgSA9QgEAIgFAJQgEAFgHAAQgLAAgHgVg");
	this.shape_284.setTransform(586.7,41.725);

	this.shape_285 = new cjs.Shape();
	this.shape_285.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAGAAAPQAAAJgLAIQgFADgPAGIgcAMQAEAFAFADQAGABAIAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIAUgIIASgKQgHgDgJgBQgHABgGAFg");
	this.shape_285.setTransform(567.5,41.55);
	...
	this.shape_286.setTransform(557.575,39.175);

	this.shape_287 = new cjs.Shape();
	this.shape_287.graphics.f("#000000").s().p("AgHA9QgDgDAAgFIAAgJIAAgKIgCgsIgQgBQgMgCAAgKQAAgFAEgDQADgEAGAAIAOABIAAgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACAAAIQABAFgEAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgMAAQgEAAgEgDg");
	this.shape_287.setTransform(547.95,40.075);

	this.shape_288 = new cjs.Shape();
	this.shape_288.graphics.f("#000000").s().p("AgPBKQgEgDgBgFIABgCQACgNAAgLIAAgrIgGABIgFABQgFAAgEgEQgDgDgBgFQAAgIAJgDIAQgBIABgKQACgUAIgJQAJgMAWAAQAPAAAAALQAAAMgOAAQgLAAgFAHQgDAGgCALIAAADIARgBQAQAAAAALQAAAMgRgBIgRABIAAAXIAAAXQAAARgCAJQgBAJgJAAQgFAAgDgDg");
	this.shape_288.setTransform(531.2,39.625);
	...
	this.shape_289.setTransform(521.996,41.65);

	this.shape_290 = new cjs.Shape();
	this.shape_290.graphics.f("#000000").s().p("AgtA4QAAgFAEgDQADgDAEAAIAMACIANABQANAAAFgIQAHgHAAgRQgEAEgFACQgGADgGAAQgRAAgMgMQgKgLAAgRQAAgYAPgOQAOgQAZAAQAJAAAFACQAGACAEAEQALACAAAMIgCAQQgDAVgBAVQgBAdgIANQgMARgcAAQgjAAAAgOgAgNgnQgHAJAAAOQAAALAEAFQAEAEAIAAQAGAAAHgHQAHgIABgIIAEgaIgGgDIgGgBQgNAAgJAKg");
	this.shape_290.setTransform(504.7,43.925);

	this.shape_291 = new cjs.Shape();
	this.shape_291.graphics.f("#000000").s().p("");
	this.shape_291.setTransform(495.425,41.45);

	this.shape_292 = new cjs.Shape();
	this.shape_292.graphics.f("#000000").s().p("AgKBAQgEgDAAgFIAAgQIgBgRIABgTIACgTQAAgFADgDQAEgEAFAAQAEAAAEAEQACADAAAFIAAATIgBATIAAARIAAAQQAAAFgDADQgEADgDAAQgGAAgDgDgAgIgsQgDgEAAgFQAAgGADgEQAFgDAEAAQAGAAAEADQAFAEAAAGQAAAFgFAEQgEAEgGAAQgEAAgFgEg");
	this.shape_292.setTransform(488.3,39.5);

	this.shape_293 = new cjs.Shape();
	this.shape_293.graphics.f("#000000").s().p("AgIBFQgDgDAAgFIAAh5QAAgGADgDQAEgCAEAAQAFAAADACQAEADAAAGIAABzQAAARgMAAQgFAAgDgDg");
	this.shape_293.setTransform(483,39.1);

	this.shape_294 = new cjs.Shape();
	this.shape_294.graphics.f("#000000").s().p("AgIBFQgDgDAAgFIAAh5QAAgGADgDQAEgCAEAAQAFAAADACQAEADAAAGIAABzQAAARgMAAQgFAAgDgDg");
	this.shape_294.setTransform(478.05,39.1);

	this.shape_295 = new cjs.Shape();
	this.shape_295.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGABAPQAAAJgLAIQgFADgPAGIgdAMQAEAFAGADQAHABAHAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgIABgFAFg");
	this.shape_295.setTransform(470.5,41.55);

	this.shape_296 = new cjs.Shape();
	this.shape_296.graphics.f("#000000").s().p("AgkBGQgDgDAAgFIAAghIAAghIgBghIgCgRQABgIADgFQAEgGAGAAQAFAAADADQAEAEgBAEIAAABIANgFQAEgBAGAAQAUAAAJARQAIANAAAUQgBATgKAMQgMAOgUAAIgPgCIAAAkQAAAFgDADQgEAEgFAAQgGAAgDgEgAgEgpQgGACgGAGIABAjQAIACAHAAQAJAAAFgFQAFgGgBgKIgBgQQgCgLgJAAQgFAAgFADg");
	this.shape_296.setTransform(460.95,43.675);

	this.shape_297 = new cjs.Shape();
	this.shape_297.graphics.f("#000000").s().p("AgYAuQgNgFAAgKQAAgIAKAAQAEAAAIACQAIADAEAAQARAAAAgHQAAgFgNgFQgRgIgFgDQgMgJAAgMQAAgSASgGQALgEAWAAQAJAAAEADQAGADAAAIQAAAQgJAAQgJAAgBgHIgIgBQgUAAAAAGQAAADAMAGQARAIAHAEQAMAJAAALQAAAPgOAIQgLAHgQAAQgLAAgKgEg");
	this.shape_297.setTransform(451.525,41.525);

	this.shape_298 = new cjs.Shape();
	this.shape_298.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAGAAAPQAAAJgLAIQgFADgPAGIgcAMQAEAFAGADQAFABAIAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIAUgIIARgKQgGgDgJgBQgHABgGAFg");
	this.shape_298.setTransform(434.3,41.55);

	this.shape_299 = new cjs.Shape();
	this.shape_299.graphics.f("#000000").s().p("");
	this.shape_299.setTransform(424.375,39.175);

	this.shape_300 = new cjs.Shape();
	this.shape_300.graphics.f("#000000").s().p("AgHA9QgDgDAAgFIAAgJIAAgKIgCgsIgQgBQgMgCAAgKQAAgFAEgDQADgEAGAAIAOABIAAgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACAAAIQABAFgEAEQgDADgFAAIgFAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgMAAQgEAAgEgDg");
	this.shape_300.setTransform(414.75,40.075);

	this.shape_301 = new cjs.Shape();
	this.shape_301.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAALAFQANAGgBAPQAAAJgKAIQgFADgPAGIgcAMQADAFAHADQAGABAGAAQAMAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgOAAQgTAAgOgKgAgLgUQgGAGgEAKIAVgIIASgKQgHgDgJgBQgHABgGAFg");
	this.shape_301.setTransform(397.55,41.55);

	this.shape_302 = new cjs.Shape();
	this.shape_302.graphics.f("#000000").s().p("AAVBCQgFgIgJgLIgMgSIgNAIIAAAXQAAAFgDADQgEAEgFAAQgNAAAAgPIACgVIABgVIAAgcIAAgdIAAgIIAAgJQAAgGACgDQAEgDAFAAQAFAAAEADQAEADgBAGIABAJIAAAJIAAAZIgBAXQAMgIAYgZQADgDAFAAQAGAAADADQAEAEAAAFQAAAEgEADQgJALgPANIATAXQANASgBAGQAAAFgDADQgEADgFAAQgHAAgDgGg");
	this.shape_302.setTransform(388.15,39.075);

	this.shape_303 = new cjs.Shape();
	this.shape_303.graphics.f("#000000").s().p("AAVAoIgOAHQgGABgDAAQgWAAgKgLQgLgMAAgWQAAgUAQgPQAPgQAVAAQAJABALAFQANAFAAAHQAAAEgCACIgBAJIgBAMQAAAQACAHIAEAJIAEAJQAAAFgEADQgDACgFAAQgEABgJgJgAgMgRQgIAKAAALQAAAMAEAFQAEAHAIAAQAFAAAFgCQAFgCAEgEQgDgUAAgKIABgGIABgIIgDgCIgDAAQgLAAgJAJg");
	this.shape_303.setTransform(378.025,41.6);

	this.shape_304 = new cjs.Shape();
	this.shape_304.graphics.f("#000000").s().p("");
	this.shape_304.setTransform(366.1278,41.625);

	this.shape_305 = new cjs.Shape();
	this.shape_305.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_305.setTransform(346.396,41.65);

	this.shape_306 = new cjs.Shape();
	this.shape_306.graphics.f("#000000").s().p("AgHA9QgDgDgBgFIAAgJIABgKIgCgsIgQgBQgMgCAAgKQABgFADgDQADgEAFAAIAPABIAAgJIAAgJQAAgFADgDQAEgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAADACQAIACgBAIQAAAFgDAEQgDADgFAAIgFAAIgEAAIgIAAIABAuIAAAEIAAAFQAAAUgMAAQgFAAgDgDg");
	this.shape_306.setTransform(337.5,40.075);

	this.shape_307 = new cjs.Shape();
	this.shape_307.graphics.f("#000000").s().p("AgYAuQgNgFAAgKQAAgIAKAAQAEAAAIACQAIADAEAAQARAAAAgHQAAgFgNgFQgRgIgFgDQgMgJAAgMQAAgSASgGQALgEAWAAQAJAAAEADQAGADAAAIQAAAQgJAAQgJAAgBgHIgIgBQgUAAAAAGQAAADAMAGQARAIAHAEQAMAJAAALQAAAPgOAIQgLAHgQAAQgLAAgKgEg");
	this.shape_307.setTransform(320.975,41.525);

	this.shape_308 = new cjs.Shape();
	this.shape_308.graphics.f("#000000").s().p("AgiAuQgCgEgBgEIAAg5IAAgIIAAgIQAAgFADgDQADgEAGAAQAKAAACAKQAOgLATAAQARAAAAAXIAAAGQAAANgMAAQgLAAABgLIgBgJQgTADgIARIAAAsQAAAFgEADQgDADgGAAQgFAAgDgDg");
	this.shape_308.setTransform(312.55,41.625);

	this.shape_309 = new cjs.Shape();
	this.shape_309.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAGAAAPQAAAJgLAIQgFADgPAGIgcAMQAEAFAFADQAGABAIAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIAUgIIARgKQgGgDgJgBQgHABgGAFg");
	this.shape_309.setTransform(302.9,41.55);

	this.shape_310 = new cjs.Shape();
	this.shape_310.graphics.f("#000000").s().p("AgHA9QgDgDgBgFIAAgJIABgKIgCgsIgQgBQgLgCAAgKQAAgFADgDQAEgEAEAAIAQABIgBgJIAAgJQAAgFADgDQAEgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAADACQAIACAAAIQgBAFgDAEQgDADgFAAIgFAAIgEAAIgIAAIABAuIAAAEIAAAFQAAAUgNAAQgEAAgDgDg");
	this.shape_310.setTransform(293.75,40.075);

	this.shape_311 = new cjs.Shape();
	this.shape_311.graphics.f("#000000").s().p("AgHA9QgEgDABgFIAAgJIAAgKIgCgsIgQgBQgMgCAAgKQAAgFAEgDQAEgEAFAAIAOABIAAgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACAAAIQAAAFgDAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgNAAQgDAAgEgDg");
	this.shape_311.setTransform(285.25,40.075);

	this.shape_312 = new cjs.Shape();
	this.shape_312.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAALAFQANAGgBAPQAAAJgKAIQgFADgPAGIgdAMQAFAFAFADQAGABAHAAQAMAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgOAAQgUAAgNgKgAgLgUQgGAGgEAKIAUgIIASgKQgFgDgKgBQgHABgGAFg");
	this.shape_312.setTransform(275.85,41.55);

	this.shape_313 = new cjs.Shape();
	this.shape_313.graphics.f("#000000").s().p("AgIBFQgDgDAAgFIAAh5QAAgGAEgDQADgCAEAAQAFAAAEACQADADAAAGIAABzQAAARgMAAQgFAAgDgDg");
	this.shape_313.setTransform(268.4,39.1);

	this.shape_314 = new cjs.Shape();
	this.shape_314.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAGAAAPQAAAJgLAIQgFADgPAGIgcAMQAEAFAFADQAHABAHAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgHABgGAFg");
	this.shape_314.setTransform(253.05,41.55);

	this.shape_315 = new cjs.Shape();
	this.shape_315.graphics.f("#000000").s().p("");
	this.shape_315.setTransform(243.125,39.175);

	this.shape_316 = new cjs.Shape();
	this.shape_316.graphics.f("#000000").s().p("AgHA9QgEgDABgFIAAgJIAAgKIgCgsIgQgBQgMgCAAgKQAAgFAEgDQAEgEAFAAIAOABIAAgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACAAAIQAAAFgDAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgMAAQgEAAgEgDg");
	this.shape_316.setTransform(233.5,40.075);

	this.shape_317 = new cjs.Shape();
	this.shape_317.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAALAFQAMAGAAAPQAAAJgKAIQgFADgPAGIgcAMQADAFAHADQAGABAGAAQAMAAAIgEQAIgEAEgBQAJAAAAAJQAAALgPAGQgMAFgOAAQgTAAgOgKgAgLgUQgGAGgEAKIAVgIIASgKQgHgDgJgBQgIABgFAFg");
	this.shape_317.setTransform(216.3,41.55);

	this.shape_318 = new cjs.Shape();
	this.shape_318.graphics.f("#000000").s().p("AgtA4QABgFADgDQACgDAGAAIALACIANABQAMAAAHgIQAFgHABgRQgEAEgGACQgFADgGAAQgSAAgKgMQgLgLAAgRQAAgYAOgOQAPgQAZAAQAJAAAFACQAHACADAEQAMACAAAMIgDAQQgEAVAAAVQgBAdgIANQgMARgcAAQgjAAAAgOgAgNgnQgHAJAAAOQAAALAEAFQAEAEAIAAQAGAAAHgHQAHgIABgIIAEgaIgGgDIgFgBQgPAAgIAKg");
	this.shape_318.setTransform(206.55,43.925);

	this.shape_319 = new cjs.Shape();
	this.shape_319.graphics.f("#000000").s().p("");
	this.shape_319.setTransform(197.275,41.45);

	this.shape_320 = new cjs.Shape();
	this.shape_320.graphics.f("#000000").s().p("AAVAoIgOAHQgGABgDAAQgWAAgKgLQgLgMAAgWQAAgUAQgPQAPgQAVAAQAJABALAFQANAFAAAHQAAAEgCACIgBAJIgBAMQAAAQACAHIAEAJIAEAJQAAAFgEADQgDACgFAAQgEABgJgJgAgMgRQgIAKAAALQAAAMAEAFQAEAHAIAAQAFAAAFgCQAFgCAEgEQgDgUAAgKIABgGIABgIIgDgCIgDAAQgLAAgJAJg");
	this.shape_320.setTransform(187.525,41.6);

	this.shape_321 = new cjs.Shape();
	this.shape_321.graphics.f("#000000").s().p("AgiAuQgDgEAAgEIAAg5IAAgIIAAgIQABgFADgDQADgEAFAAQAKAAABAKQAPgLATAAQASAAAAAXIAAAGQgBANgMAAQgKAAgBgLIAAgJQgTADgJARIAAAsQAAAFgDADQgDADgFAAQgGAAgDgDg");
	this.shape_321.setTransform(178.3,41.625);

	this.shape_322 = new cjs.Shape();
	this.shape_322.graphics.f("#000000").s().p("AgiAuQgDgEAAgEIAAg5IAAgIIAAgIQAAgFAEgDQADgEAFAAQAKAAACAKQAOgLATAAQASAAAAAXIAAAGQgBANgMAAQgKAAgBgLIAAgJQgTADgIARIAAAsQgBAFgDADQgDADgFAAQgGAAgDgDg");
	this.shape_322.setTransform(169.65,41.625);

	this.shape_323 = new cjs.Shape();
	this.shape_323.graphics.f("#000000").s().p("AAtBCQgHAAgHgQQgFgKgDgOIgWACIgUACQgEAKgKATQgEAHgHAAQgFAAgDgDQgEgEAAgFQAAgEANgaQgCgDABgCQAAgFAIgCIAcgsQAVghAFAAQAKAAADAMIAFAcIANA5IAFALQADAIAAAEQAAAFgEADQgDADgEAAIgBAAgAgGAIIALgBIANgBIgGgdIgSAfg");
	this.shape_323.setTransform(158.525,39.5781);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Game
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EE3538").s().p("AoFMzQh9AAhYhYQhYhZAAh8IAAwLQAAh8BYhYQBYhZB9AAIQLAAQB8AABZBZQBYBYAAB8IAAQLQAAB8hYBZQhZBYh8AAg");
	this.shape.setTransform(117.533,411.3405,0.7068,0.7068);
