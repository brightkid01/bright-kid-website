...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	// timeline functions:
	this.frame_1 = function() {
		/* _root.h_mc.b1.enabled=false;
		_root.m_mc.b2.enabled=false;
		_root.u_mc.b3.enabled=false;
		_root.s_mc.b4.enabled=false;
		_root.b_mc.b5.enabled=false;
		_root.o_mc.b6.enabled=false;
		_root.r_mc.b7.enabled=false;*/
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(386).call(this.frame_387).wait(2));
...
(lib.TriangleIcon = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#050505").s().p("Ah0CIQgxgoAAhAQAAhJAvg+QA0hFBPAAQBNAAAmAjQAmAjAABHQAABJgrA9QgyBGhPAAQhBAAgtglgAhGhBQghAsAAA1QAAAlAdAXQAbAWApAAQAwAAAggwQAegrAAg2QAAgugVgSQgUgSgyAAQgwAAgjAwg");
	this.shape.setTransform(-3.975,4.475);
...
p.nominalBounds = new cjs.Rectangle(-23.9,-31.1,40.099999999999994,66.7);
...
(lib.StarIcon = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#050505").s().p("AhhEVQgIgPABgVIAAhTIAAhTIAAkqQAAgYAIgUQAIgZARACIAtAHQAYAHARASQBMBQABB2QAAAwgQAlQgRAlgfAZQAvA3AYA5QAHAPgBASQABAVgIAPQgIAPgKAAQgKAAgIgQQg2hphBgpIACB4QAAAVgGAPQgIAOgKAAQgLAAgHgOgAg3AKIAIABQAsAAAUgWQAJgJAIgQQAHgQAAgIQABgqgagmQgYglgagFIgVgDg");
	this.shape.setTransform(-2.15,-1.9114);
...
(lib.SquarePiececopy = function(mode,startPosition,loop) {
	...
	// Rec
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#373535").s().p("AhrCnQgLgLAAgNIAAjoIgBgdQgBgRACgMQADgVAjgEQARgFAnAAQAoAAAmAbQAtAfAAAvQAAAZgJARQgHAPgTAPQAWAKAQAVQATAXAAAXQAAAdggAbQgVARgYAJQgyAThOAAQgNAAgKgLgAg6B2QAmgCArgNQAmgLAAgNQgBgRgYgNQgTgKgQgCIg7gCgAg6h1IAAAvIAAAuQAUACAKgBQBCgFAAgsQAAgQgUgOQgTgPgXAAIgiAAg");
	this.shape.setTransform(-5.055,-0.575);
...
(lib.SquarePiece = function(mode,startPosition,loop) {
	...
	// Rec
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#373535").s().p("");
	this.shape.setTransform(-5.4,-0.45);
...
(lib.RoundedSquarePiececopy2 = function(mode,startPosition,loop) {
	...
	// Icon
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#373535").s().p("");
	this.shape.setTransform(-2.8,6.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.slot3.setTransform(96.6,345.2,0.6957,0.6957);

	this.slot5 = new lib.Slot();
	this.slot5.name = "slot5";
	this.slot5.setTransform(772.3,352.05,0.6957,0.6957,0,0,0,0.1,0.1);

	this.slot1 = new lib.Slot();
	this.slot1.name = "slot1";
	this.slot1.setTransform(661.1,348.75,0.6957,0.6957);

	this.slot6 = new lib.Slot();
	this.slot6.name = "slot6";
	this.slot6.setTransform(545.9,344.7,0.6957,0.6957);

	this.slot4 = new lib.Slot();
	this.slot4.name = "slot4";
	this.slot4.setTransform(428.35,344.7,0.6957,0.6957);

	this.slot2 = new lib.Slot();
	this.slot2.name = "slot2";
	this.slot2.setTransform(318.95,344.7,0.6957,0.6957);

	this.slot0 = new lib.Slot();
	this.slot0.name = "slot0";
	this.slot0.setTransform(212.35,344.7,0.6957,0.6957);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.slot0},{t:this.slot2},{t:this.slot4},{t:this.slot6},{t:this.slot1},{t:this.slot5},{t:this.slot3}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slots, new cjs.Rectangle(48.7,296.8,771.5999999999999,103.19999999999999), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.piece6 = new lib.SquarePiececopy();
	this.piece6.name = "piece6";
	this.piece6.setTransform(111.55,191.55,0.8101,0.8101,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.piece6, 0, 1, 1);

	this.piece5 = new lib.RoundedSquarePiececopy2();
	this.piece5.name = "piece5";
	this.piece5.setTransform(780.3,193.6,0.8101,0.8101,0,0,0,0.1,0.3);
	new cjs.ButtonHelper(this.piece5, 0, 1, 1);

	this.piece1 = new lib.RoundedSquarePiececopy();
	this.piece1.name = "piece1";
	this.piece1.setTransform(657.5,190.1,0.8101,0.8101,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.piece1, 0, 1, 1);

	this.piece4 = new lib.RoundedSquarePiece();
	this.piece4.name = "piece4";
	this.piece4.setTransform(538.4,191.55,0.8101,0.8101,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.piece4, 0, 1, 1);

	this.piece3 = new lib.StarPiece();
	this.piece3.name = "piece3";
	this.piece3.setTransform(418.65,191.45,0.8101,0.8101);
	new cjs.ButtonHelper(this.piece3, 0, 1, 1);

	this.piece2 = new lib.TrianglePiece();
	this.piece2.name = "piece2";
	this.piece2.setTransform(312.4,191.55,0.8101,0.8101,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.piece2, 0, 1, 1);

	this.piece0 = new lib.SquarePiece();
	this.piece0.name = "piece0";
	this.piece0.setTransform(214.7,191.55,0.8101,0.8101,0,0,0,0.1,0.1);
	new cjs.ButtonHelper(this.piece0, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.piece0},{t:this.piece2},{t:this.piece3},{t:this.piece4},{t:this.piece1},{t:this.piece5},{t:this.piece6}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Pieces, new cjs.Rectangle(65.6,138.6,760.4,100.6), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(120.8587,29.4679,0.3728,0.3728);
	...
	this.shape_1.setTransform(60.0795,45.1158,0.3724,0.3724);
	...
	this.shape_2.setTransform(59.8467,46.8976,0.3728,0.3728);
	...
	this.shape_3.setTransform(52.0522,47.9053,0.3728,0.3728);
	...
	this.shape_4.setTransform(52.0447,47.8773,0.3728,0.3728);
	...
	this.shape_5.setTransform(49.8773,42.5852,0.3728,0.3728);
	...
	this.shape_6.setTransform(49.8712,42.613,0.3728,0.3728);
	...
	this.shape_7.setTransform(49.4485,44.0733,0.3724,0.3724);
	...
	this.shape_8.setTransform(49.1476,45.7691,0.3728,0.3728);
	...
	this.shape_9.setTransform(52.2124,48.0637,0.3728,0.3728);
	...
	this.shape_10.setTransform(52.2031,48.0264,0.3728,0.3728);
	...
	this.shape_11.setTransform(50.0254,42.7436,0.3728,0.3728);
	...
	this.shape_12.setTransform(50.0216,42.7622,0.3728,0.3728);
	...
	this.shape_13.setTransform(49.3222,46.023,0.3728,0.3728);
	...
	this.shape_14.setTransform(49.3036,45.9364,0.3728,0.3728);
	...
	this.shape_26.setTransform(119.1343,35.7085,0.3728,0.3728);
	...
	this.shape_52.setTransform(118.6403,35.3403,0.3728,0.3728);
	...
	this.shape_60.setTransform(118.6216,35.015,0.3728,0.3728);
	...
	this.shape_61.setTransform(118.6216,35.015,0.3728,0.3728);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#CB7246").s().p("AgFAAQAAgEAFgBQAGgBAAAGQAAAGgGAAQgFABAAgHg");
	this.shape_62.setTransform(115.2473,36.2444,0.3728,0.3728);
	...
	this.shape_63.setTransform(116.201,42.4524,0.3728,0.3728);
	...
	this.shape_70.setTransform(117.1467,40.9167,0.3728,0.3728);
	...
	this.shape_71.setTransform(117.1447,40.8957,0.3728,0.3728);
	...
	this.shape_72.setTransform(115.0625,40.4669,0.3728,0.3728);
	...
	this.shape_73.setTransform(114.0036,45.9528,0.3728,0.3728);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f().s("#EE3338").ss(0.2,0,0,2.6).p("Ag1AHIAlgKQAqgIAbAO");
	this.shape_74.setTransform(71.3821,33.1602,0.3728,0.3728);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#373535").s().p("AgCAmIgLgDIAXhQIAEBbQgFgFgLgDg");
	this.shape_75.setTransform(105.1059,34.0167,0.3728,0.3728);
	...
	this.shape_76.setTransform(102.9635,40.3364,0.3728,0.3728);
	...
	this.shape_77.setTransform(102.3759,46.9897,0.3728,0.3728);
	...
	this.shape_78.setTransform(97.7153,44.4316,0.3728,0.3728);
	...
	this.shape_87.setTransform(95.9711,50.355,0.3728,0.3728);
	...
	this.shape_88.setTransform(99.7275,36.3479,0.3728,0.3728);
	...
	this.shape_89.setTransform(97.5463,43.3752,0.3728,0.3728);
	...
	this.shape_90.setTransform(97.537,43.3565,0.3728,0.3728);
	...
	this.shape_91.setTransform(95.8965,50.3567,0.3728,0.3728);
	...
	this.shape_92.setTransform(95.8973,50.3558,0.3728,0.3728);
	...
	this.shape_106.setTransform(72.2765,34.5293,0.3728,0.3728);
	...
	this.shape_107.setTransform(70.6919,34.5853,0.3728,0.3728);

	this.shape_108 = new cjs.Shape();
	this.shape_108.graphics.f("#373535").s().p("AgEAAQAAgFAEAAQAFAAAAAFQAAAGgFAAQgEAAAAgGg");
	this.shape_108.setTransform(72.2765,34.5107,0.3728,0.3728);

	this.shape_109 = new cjs.Shape();
	this.shape_109.graphics.f("#373535").s().p("AgFAAQAAgFAFAAQAGAAAAAFQAAAGgGAAQgFAAAAgGg");
	this.shape_109.setTransform(70.7013,34.5759,0.3728,0.3728);
	...
	this.shape_114.setTransform(71.3899,34.1885,0.3728,0.3728);
	...
	this.shape_115.setTransform(71.6121,33.0685,0.3724,0.3724);
	...
	this.shape_116.setTransform(71.3724,34.8462,0.3728,0.3728);
	...
	this.shape_117.setTransform(87.8803,44.6708,0.3728,0.3728);
	...
	this.shape_118.setTransform(87.8616,44.6894,0.3728,0.3728);
	...
	this.shape_119.setTransform(80.2555,46.7121,0.3728,0.3728);
	...
	this.shape_120.setTransform(80.2548,46.7205,0.3728,0.3728);
	...
	this.shape_121.setTransform(107.7344,40.9889,0.3728,0.3728);
	...
	this.shape_122.setTransform(107.7251,40.9889,0.3728,0.3728);
	...
	this.shape_123.setTransform(107.8649,47.0011,0.3728,0.3728);
	...
	this.shape_124.setTransform(107.8649,47.0197,0.3728,0.3728);
	...
	this.shape_125.setTransform(65.528,40.9889,0.3728,0.3728);
	...
	this.shape_126.setTransform(65.5187,40.9889,0.3728,0.3728);
	...
	this.shape_127.setTransform(65.6585,47.0011,0.3728,0.3728);
	...
	this.shape_140.setTransform(75.5301,46.5084,0.3728,0.3728);
	...
	this.shape_141.setTransform(67.8112,45.9941,0.3728,0.3728);
	...
	this.shape_142.setTransform(68.9487,37.3909,0.3728,0.3728);
	...
	this.shape_143.setTransform(67.9658,34.7387,0.3728,0.3728);
	...
	this.shape_144.setTransform(67.9471,34.7475,0.3728,0.3728);
	...
	this.shape_145.setTransform(71.3824,39.1526,0.3728,0.3728);
	...
	this.shape_146.setTransform(71.3802,39.1247,0.3728,0.3728);
	...
	this.shape_147.setTransform(73.5269,37.8694,0.3728,0.3728);
	...
	this.shape_148.setTransform(74.22,39.7515,0.3728,0.3728);
	...
	this.shape_149.setTransform(74.22,39.7702,0.3728,0.3728);

	this.shape_150 = new cjs.Shape();
	this.shape_150.graphics.f("#00B0F0").s().p("AgIAZIgPgEIAIgrIAmgDIABAxQgKACgKAAIgMgBg");
	this.shape_150.setTransform(71.3724,37.8794,0.3728,0.3728);
	...
	this.shape_151.setTransform(71.4938,43.8545,0.3728,0.3728);
	...
	this.shape_152.setTransform(72.1367,47.4392,0.3728,0.3728);
	...
	this.shape_153.setTransform(72.3849,46.3913,0.3724,0.3724);

	this.shape_154 = new cjs.Shape();
	this.shape_154.graphics.f("#EE3338").s().p("AglgDIAqglIAhBRg");
	this.shape_154.setTransform(54.8738,53.6937,0.3728,0.3728);

	this.shape_155 = new cjs.Shape();
	this.shape_155.graphics.f("#EE3338").s().p("AgagjIA1gIIgNBXg");
	this.shape_155.setTransform(50.1107,55.7817,0.3728,0.3728);

	this.shape_156 = new cjs.Shape();
	this.shape_156.graphics.f("#DE3438").s().p("AgoADIBRgwIgmBbg");
	this.shape_156.setTransform(56.0763,39.2459,0.3728,0.3728);

	this.shape_157 = new cjs.Shape();
	this.shape_157.graphics.f("#EE3338").s().p("AgdApIAkhZIAXBhg");
	this.shape_157.setTransform(50.7166,36.058,0.3728,0.3728);

	this.shape_158 = new cjs.Shape();
	this.shape_158.graphics.f("#F26C36").s().p("AgZhhIAzALIgyC4g");
	this.shape_158.setTransform(47.7431,57.4595,0.3728,0.3728);

	this.shape_159 = new cjs.Shape();
	this.shape_159.graphics.f("#F26C36").s().p("AgjhfIBHC0Ig0ALg");
	this.shape_159.setTransform(47.6219,34.6319,0.3728,0.3728);

	this.shape_160 = new cjs.Shape();
	this.shape_160.graphics.f("#F26C36").s().p("Ag3g9IAhgZIBOCsg");
	this.shape_160.setTransform(53.7739,56.5274,0.3728,0.3728);

	this.shape_161 = new cjs.Shape();
	this.shape_161.graphics.f("#F26C36").s().p("Ag2BDIBtiYIhJCrg");
	this.shape_161.setTransform(54.5103,35.6479,0.3728,0.3728);

	this.shape_162 = new cjs.Shape();
	this.shape_162.graphics.f("#373535").s().p("AhQAAICfgYIAAANQAAARACATg");
	this.shape_162.setTransform(38.9252,46.5444,0.3728,0.3728);
	...
	this.shape_163.setTransform(60.0238,47.0943,0.3728,0.3728);
	...
	this.shape_164.setTransform(60.0431,47.0841,0.3728,0.3728);
	...
	this.shape_165.setTransform(52.2142,48.1202,0.3728,0.3728);
	...
	this.shape_166.setTransform(52.2404,48.0637,0.3728,0.3728);
	...
	this.shape_167.setTransform(50.0685,43.1176,0.3728,0.3728);
	...
	this.shape_168.setTransform(50.0685,42.7901,0.3728,0.3728);
	...
	this.shape_169.setTransform(49.3942,45.9555,0.3728,0.3728);
	...
	this.shape_202.setTransform(118.8376,35.5267,0.3728,0.3728);
	...
	this.shape_203.setTransform(117.8013,35.6013,0.3728,0.3728);

	this.shape_204 = new cjs.Shape();
	this.shape_204.graphics.f().s("#201F1F").ss(0.2,0,0,2.6).p("AACgGQACAAABADQACACgBACQgCAIgEgBQgGgBACgHQACgIAEACg");
	this.shape_204.setTransform(117.641,35.5171,0.3728,0.3728);
	...
	this.shape_205.setTransform(117.641,35.5171,0.3728,0.3728);
	...
	this.shape_206.setTransform(117.7268,35.2013,0.3728,0.3728);
	...
	this.shape_209.setTransform(118.6962,35.4374,0.3728,0.3728);

	this.shape_210 = new cjs.Shape();
	this.shape_210.graphics.f("#373535").s().p("AgFAAQgBgEAGgCQAFAAABAGQAAAGgGABQgFgBAAgGg");
	this.shape_210.setTransform(115.4497,36.4309,0.3728,0.3728);
	...
	this.shape_211.setTransform(116.4003,42.6391,0.3728,0.3728);
	...
	this.shape_218.setTransform(117.4634,39.2383,0.3724,0.3724);
	...
	this.shape_219.setTransform(117.2845,40.9982,0.3728,0.3728);
	...
	this.shape_220.setTransform(115.2567,40.6534,0.3728,0.3728);
	...
	this.shape_225.setTransform(103.1564,40.5229,0.3728,0.3728);
	...
	this.shape_226.setTransform(102.1528,47.0582,0.3728,0.3728);
	...
	this.shape_227.setTransform(97.9112,44.618,0.3728,0.3728);
	...
	this.shape_232.setTransform(95.9256,50.5321,0.3728,0.3728);
	...
	this.shape_233.setTransform(99.9046,36.3573,0.3728,0.3728);
	...
	this.shape_234.setTransform(97.7235,43.5523,0.3728,0.3728);
	...
	this.shape_235.setTransform(97.7328,43.5429,0.3728,0.3728);
	...
	this.shape_236.setTransform(96.0456,50.5216,0.3728,0.3728);
	...
	this.shape_237.setTransform(96.0838,50.594,0.3728,0.3728);
	...
	this.shape_238.setTransform(99.9419,36.4354,0.3728,0.3728);
	...
	this.shape_239.setTransform(99.8685,36.3237,0.3728,0.3728);

	this.shape_240 = new cjs.Shape();
	this.shape_240.graphics.f().s("#EE3338").ss(0.5,0,0,2.6).p("AAEAFQgFgFAAgFQAAABAAAAIgCAHIAFAGg");
	this.shape_240.setTransform(98.2878,44.323,0.3728,0.3728);

	this.shape_241 = new cjs.Shape();
	this.shape_241.graphics.f("#373535").s().p("AgDABIACgHIAAgBQAAAFAFAFIgCAEg");
	this.shape_241.setTransform(98.2827,44.3912,0.3728,0.3728);
	...
	this.shape_242.setTransform(88.076,44.8572,0.3728,0.3728);
	...
	this.shape_243.setTransform(88.0667,44.8665,0.3728,0.3728);
	...
	this.shape_244.setTransform(80.4512,46.8986,0.3728,0.3728);
	...
	this.shape_245.setTransform(80.4598,46.907,0.3728,0.3728);
	...
	this.shape_246.setTransform(107.9302,41.1753,0.3728,0.3728);
	...
	this.shape_247.setTransform(107.9209,41.1753,0.3728,0.3728);
	...
	this.shape_248.setTransform(108.0607,47.1875,0.3728,0.3728);
	...
	this.shape_249.setTransform(108.0607,47.1969,0.3728,0.3728);
	...
	this.shape_250.setTransform(65.9702,39.3901,0.3724,0.3724);
	...
	this.shape_251.setTransform(65.7237,41.1753,0.3728,0.3728);
	...
	this.shape_252.setTransform(65.8542,47.1875,0.3728,0.3728);
	...
	this.shape_258.setTransform(72.3418,47.6256,0.3728,0.3728);
	...
	this.shape_259.setTransform(72.5804,46.5775,0.3724,0.3724);

	this.shape_260 = new cjs.Shape();
	this.shape_260.graphics.f("#373535").s().p("AgkgDIAogjIAgBNg");
	this.shape_260.setTransform(55.0043,53.8336,0.3728,0.3728);

	this.shape_261 = new cjs.Shape();
	this.shape_261.graphics.f("#373535").s().p("AgZgkIAzgHIgNBXg");
	this.shape_261.setTransform(50.1946,55.9588,0.3728,0.3728);

	this.shape_262 = new cjs.Shape();
	this.shape_262.graphics.f("#373535").s().p("AgoADIBRgxIglBdg");
	this.shape_262.setTransform(56.0949,39.4323,0.3728,0.3728);

	this.shape_263 = new cjs.Shape();
	this.shape_263.graphics.f("#373535").s().p("AgdAqIAkhaIAXBhg");
	this.shape_263.setTransform(50.8378,36.2351,0.3728,0.3728);

	this.shape_264 = new cjs.Shape();
	this.shape_264.graphics.f("#373535").s().p("AgahhIA0ALIgyC4g");
	this.shape_264.setTransform(47.7524,57.6366,0.3728,0.3728);

	this.shape_265 = new cjs.Shape();
	this.shape_265.graphics.f("#373535").s().p("AgjhfIBHC0Ig0AKg");
	this.shape_265.setTransform(47.7897,34.809,0.3728,0.3728);

	this.shape_266 = new cjs.Shape();
	this.shape_266.graphics.f("#373535").s().p("Ag2g9IAggZIBNCtg");
	this.shape_266.setTransform(53.9231,56.7325,0.3728,0.3728);

	this.shape_267 = new cjs.Shape();
	this.shape_267.graphics.f("#373535").s().p("Ag2BDIBtiYIhJCrg");
	this.shape_267.setTransform(54.5103,35.8343,0.3728,0.3728);
	...
	this.shape_268.setTransform(99.1869,56.0427,0.3728,0.3728);
	...
	this.shape_269.setTransform(99.1962,56.024,0.3728,0.3728);
	...
	this.shape_270.setTransform(78.9299,53.8301,0.3724,0.3724);
	...
	this.shape_271.setTransform(78.7082,55.6325,0.3728,0.3728);
	...
	this.shape_272.setTransform(104.9754,63.1153,0.3728,0.3728);
	...
	this.shape_273.setTransform(68.1286,61.7473,0.3728,0.3728);
	...
	this.shape_274.setTransform(80.2357,47.7856,0.3728,0.3728);
	...
	this.shape_275.setTransform(80.4002,47.9558,0.3728,0.3728);
	...
	this.shape_276.setTransform(80.414,47.7654,0.3728,0.3728);

	this.shape_277 = new cjs.Shape();
	this.shape_277.graphics.f("#000000").s().p("AgJAJQgEgEAAgEQAAgEAEgEQAEgEAFAAQAGAAAEAEQAEADAAAFQAAAEgEAEQgEADgGAAQgFAAgEgDg");
	this.shape_277.setTransform(701.025,45.65);

	this.shape_278 = new cjs.Shape();
	this.shape_278.graphics.f("#000000").s().p("AgYAuQgNgFAAgKQAAgIAKAAQAEAAAIACQAIADAEAAQARAAAAgHQAAgFgNgFQgRgIgFgDQgMgJAAgMQAAgSASgGQALgEAWAAQAJAAAEADQAGADAAAIQAAAQgJAAQgJAAgBgHIgIgBQgUAAAAAGQAAADAMAGQARAIAHAEQAMAJAAALQAAAPgOAIQgLAHgQAAQgLAAgKgEg");
	this.shape_278.setTransform(692.675,41.525);
	...
	this.shape_279.setTransform(683.6528,41.65);

	this.shape_280 = new cjs.Shape();
	this.shape_280.graphics.f("#000000").s().p("AgZBDQgEADgEAAQgFAAgDgDQgEgDAAgFIAAgGIABgHIAAhjQAAgGADgEQADgHAHAAQAJAAAAAKIAAAEIgBADIAAAiQAHgDAGgCQAGgCAEAAQAVAAANAPQAMANAAAUQAAAVgOANQgOAPgUAAQgMAAgLgEgAgJgBIgOAHIAAAmQAMAEAJAAQAKABAHgIQAIgHAAgMQAAgLgGgIQgHgGgKAAQgDAAgGACg");
	this.shape_280.setTransform(673.725,39.2);

	this.shape_281 = new cjs.Shape();
	this.shape_281.graphics.f("#000000").s().p("");
	this.shape_281.setTransform(661.5278,41.625);

	this.shape_282 = new cjs.Shape();
	this.shape_282.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_282.setTransform(649.596,41.65);
	...
	this.shape_283.setTransform(639.925,39.175);

	this.shape_284 = new cjs.Shape();
	this.shape_284.graphics.f("#000000").s().p("AgvBCQgEgEAAgFIABgTIAAgUIAAhGQAAgGADgEQAFgGAIAAIAWACQAMABAHAFQAmATAAAcQAAALgIAIQgIAJgPAGQAXANAMANQADAEAAAEQAAAFgEAEQgEADgFAAQgFAAgDgDQgbgZgfgKIABAcQAAAFgEAEQgDADgFAAQgGAAgDgDgAgaADIADAAQAWAAAJgFQAFgCAEgEQADgDAAgCQAAgKgMgJQgLgJgNgBIgKgBg");
	this.shape_284.setTransform(629.025,39.3481);

	this.shape_285 = new cjs.Shape();
	this.shape_285.graphics.f("#000000").s().p("AAYBCQgGAEgGABIgMABQgUAAgNgNQgNgNAAgTQAAgYANgOQANgOAVAAQAGAAAGACIAJADQABgeABgKQACgLAKAAQAFAAADADQADAEAAAFIgCAmIgCAlQAAAgACAKIABADQAAAEgEAEQgDADgFAAQgHAAgDgGgAgRAEQgHAHAAAPQAAAKAHAGQAHAIAKgBQAFAAAEgBIAIgGIADgCIAAghQgDgFgFgCQgEgCgHgBQgMABgGAGg");
	this.shape_285.setTransform(609.875,39.15);

	this.shape_286 = new cjs.Shape();
	this.shape_286.graphics.f("#000000").s().p("AgiAuQgCgEgBgEIAAg5IAAgIIAAgIQAAgFADgDQADgEAGAAQAKAAACAKQAOgLATAAQARAAAAAXIAAAGQAAANgMAAQgLAAABgLIgBgJQgTADgIARIAAAsQAAAFgEADQgDADgGAAQgFAAgDgDg");
	this.shape_286.setTransform(600.55,41.625);

	this.shape_287 = new cjs.Shape();
	this.shape_287.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_287.setTransform(591.296,41.65);

	this.shape_288 = new cjs.Shape();
	this.shape_288.graphics.f("#000000").s().p("AADAcQgCgIgDgVIgCAEIgNAiQgBAEgDACQgEAGgHAAQgEAAgFgHQgFgIgDgMQgDgLgFgkIgCgMQAAgFAEgDQAEgDAFAAQAKAAACAJIACAMIABANIADAVIAPgrQAEgMAJAAQAJAAAEANIAFAXIAEAYIAOg1QABgHAKAAQAEAAAFADQADADAAAFIAAADIgTA9QgCAIgHAJQgEAFgGAAQgLAAgHgVg");
	this.shape_288.setTransform(580.6,41.725);

	this.shape_289 = new cjs.Shape();
	this.shape_289.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGABAPQAAAJgLAIQgFADgPAGIgdAMQAEAFAGADQAHABAHAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgIABgFAFg");
	this.shape_289.setTransform(561.4,41.55);

	this.shape_290 = new cjs.Shape();
	this.shape_290.graphics.f("#000000").s().p("");
	this.shape_290.setTransform(551.475,39.175);

	this.shape_291 = new cjs.Shape();
	this.shape_291.graphics.f("#000000").s().p("AgHA9QgEgDABgFIAAgJIAAgKIgCgsIgQgBQgMgCABgKQAAgFADgDQAEgEAFAAIAPABIgBgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACABAIQAAAFgEAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgNAAQgDAAgEgDg");
	this.shape_291.setTransform(541.85,40.075);

	this.shape_292 = new cjs.Shape();
	this.shape_292.graphics.f("#000000").s().p("AgQBKQgDgDAAgFIAAgCQACgNAAgLIAAgrIgGABIgFABQgGAAgDgEQgEgDAAgFQAAgIAJgDIAPgBIABgKQADgUAIgJQAJgMAWAAQAQAAAAALQgBAMgOAAQgLAAgFAHQgDAGgBALIgBADIARgBQAQAAAAALQAAAMgRgBIgRABIAAAXIABAXQgBARgCAJQgCAJgIAAQgFAAgEgDg");
	this.shape_292.setTransform(525.1,39.625);

	this.shape_293 = new cjs.Shape();
	this.shape_293.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_293.setTransform(515.896,41.65);

	this.shape_294 = new cjs.Shape();
	this.shape_294.graphics.f("#000000").s().p("AgtA4QABgFADgDQACgDAGAAIALACIANABQAMAAAHgIQAFgHABgRQgEAEgGACQgFADgGAAQgSAAgKgMQgLgLAAgRQAAgYAOgOQAPgQAZAAQAJAAAFACQAHACADAEQAMACAAAMIgDAQQgEAVAAAVQgBAdgIANQgMARgcAAQgjAAAAgOgAgNgnQgHAJAAAOQAAALAEAFQAEAEAIAAQAGAAAHgHQAHgIABgIIAEgaIgGgDIgFgBQgPAAgIAKg");
	this.shape_294.setTransform(498.6,43.925);

	this.shape_295 = new cjs.Shape();
	this.shape_295.graphics.f("#000000").s().p("");
	this.shape_295.setTransform(489.325,41.45);

	this.shape_296 = new cjs.Shape();
	this.shape_296.graphics.f("#000000").s().p("AgKBAQgEgDABgFIgBgQIAAgRIABgTIABgTQgBgFAEgDQAEgEAEAAQAFAAADAEQADADAAAFIAAATIgBATIAAARIAAAQQABAFgEADQgEADgEAAQgFAAgDgDgAgIgsQgDgEAAgFQAAgGADgEQAFgDAEAAQAGAAAFADQADAEABAGQgBAFgDAEQgFAEgGAAQgEAAgFgEg");
	this.shape_296.setTransform(482.2,39.5);

	this.shape_297 = new cjs.Shape();
	this.shape_297.graphics.f("#000000").s().p("AgIBFQgDgDAAgFIAAh5QAAgGADgDQAEgCAEAAQAFAAADACQAEADAAAGIAABzQAAARgMAAQgFAAgDgDg");
	this.shape_297.setTransform(476.9,39.1);
	...
	this.shape_298.setTransform(471.95,39.1);

	this.shape_299 = new cjs.Shape();
	this.shape_299.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAALAFQANAGgBAPQAAAJgKAIQgFADgPAGIgdAMQAFAFAFADQAGABAIAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgEAKIAUgIIASgKQgFgDgKgBQgHABgGAFg");
	this.shape_299.setTransform(464.4,41.55);

	this.shape_300 = new cjs.Shape();
	this.shape_300.graphics.f("#000000").s().p("AgkBGQgDgDAAgFIAAghIAAghIgBghIgBgRQAAgIACgFQAEgGAHAAQAFAAADADQADAEAAAEIAAABIANgFQAEgBAGAAQAVAAAIARQAIANgBAUQABATgLAMQgMAOgUAAIgPgCIAAAkQAAAFgEADQgDAEgFAAQgGAAgDgEgAgEgpQgGACgFAGIABAjQAHACAHAAQAJAAAFgFQAFgGgBgKIgBgQQgDgLgIAAQgFAAgFADg");
	this.shape_300.setTransform(454.85,43.675);

	this.shape_301 = new cjs.Shape();
	this.shape_301.graphics.f("#000000").s().p("AgYAuQgNgFAAgKQAAgIAKAAQAEAAAIACQAIADAEAAQARAAAAgHQAAgFgNgFQgRgIgFgDQgMgJAAgMQAAgSASgGQALgEAWAAQAJAAAEADQAGADAAAIQAAAQgJAAQgJAAgBgHIgIgBQgUAAAAAGQAAADAMAGQARAIAHAEQAMAJAAALQAAAPgOAIQgLAHgQAAQgLAAgKgEg");
	this.shape_301.setTransform(445.425,41.525);

	this.shape_302 = new cjs.Shape();
	this.shape_302.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGABAPQAAAJgLAIQgFADgPAGIgdAMQAEAFAGADQAHABAHAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgIABgFAFg");
	this.shape_302.setTransform(428.2,41.55);

	this.shape_303 = new cjs.Shape();
	this.shape_303.graphics.f("#000000").s().p("");
	this.shape_303.setTransform(418.275,39.175);

	this.shape_304 = new cjs.Shape();
	this.shape_304.graphics.f("#000000").s().p("AgHA9QgEgDABgFIAAgJIAAgKIgCgsIgQgBQgMgCABgKQAAgFADgDQAEgEAFAAIAPABIgBgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACABAIQAAAFgEAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgNAAQgDAAgEgDg");
	this.shape_304.setTransform(408.65,40.075);

	this.shape_305 = new cjs.Shape();
	this.shape_305.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGAAAPQABAJgLAIQgFADgPAGIgcAMQADAFAHADQAFABAHAAQAMAAAIgEQAIgEAEgBQAJAAAAAJQAAALgPAGQgMAFgOAAQgTAAgOgKgAgLgUQgGAGgDAKIAUgIIASgKQgHgDgJgBQgHABgGAFg");
	this.shape_305.setTransform(391.45,41.55);

	this.shape_306 = new cjs.Shape();
	this.shape_306.graphics.f("#000000").s().p("AAVBCQgFgIgJgLIgMgSIgNAIIAAAXQAAAFgEADQgDAEgGAAQgLAAAAgPIABgVIABgVIAAgcIAAgdIAAgIIAAgJQAAgGACgDQAEgDAFAAQAFAAAEADQAEADAAAGIAAAJIABAJIgBAZIAAAXQALgIAYgZQADgDAGAAQAEAAAFADQADAEAAAFQAAAEgDADQgLALgOANIATAXQAMASAAAGQAAAFgDADQgEADgFAAQgHAAgDgGg");
	this.shape_306.setTransform(382.05,39.075);

	this.shape_307 = new cjs.Shape();
	this.shape_307.graphics.f("#000000").s().p("AAVAoIgOAHQgGABgDAAQgWAAgKgLQgLgMAAgWQAAgUAQgPQAPgQAVAAQAJABALAFQANAFAAAHQAAAEgCACIgBAJIgBAMQAAAQACAHIAEAJIAEAJQAAAFgEADQgDACgFAAQgEABgJgJgAgMgRQgIAKAAALQAAAMAEAFQAEAHAIAAQAFAAAFgCQAFgCAEgEQgDgUAAgKIABgGIABgIIgDgCIgDAAQgLAAgJAJg");
	this.shape_307.setTransform(371.925,41.6);

	this.shape_308 = new cjs.Shape();
	this.shape_308.graphics.f("#000000").s().p("");
	this.shape_308.setTransform(360.0278,41.625);

	this.shape_309 = new cjs.Shape();
	this.shape_309.graphics.f("#000000").s().p("AgcAlQgNgMAAgUQgBgTALgPQAOgSAWAAQASAAAKAOQAKANAAASQAAATgLAPQgNAQgTAAQgQAAgMgLgAgMgOQgFAJAAAKQAAAKAGAGQAFAEAGAAQAHAAAFgFQAHgGAAgKQABgcgQAAQgKAAgGAKg");
	this.shape_309.setTransform(340.296,41.65);

	this.shape_310 = new cjs.Shape();
	this.shape_310.graphics.f("#000000").s().p("AgHA9QgEgDAAgFIAAgJIABgKIgCgsIgQgBQgMgCAAgKQABgFADgDQADgEAGAAIAOABIAAgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAADACQAIACgBAIQABAFgEAEQgDADgFAAIgFAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgMAAQgEAAgEgDg");
	this.shape_310.setTransform(331.4,40.075);

	this.shape_311 = new cjs.Shape();
	this.shape_311.graphics.f("#000000").s().p("AgYAuQgNgFAAgKQAAgIAKAAQAEAAAIACQAIADAEAAQARAAAAgHQAAgFgNgFQgRgIgFgDQgMgJAAgMQAAgSASgGQALgEAWAAQAJAAAEADQAGADAAAIQAAAQgJAAQgJAAgBgHIgIgBQgUAAAAAGQAAADAMAGQARAIAHAEQAMAJAAALQAAAPgOAIQgLAHgQAAQgLAAgKgEg");
	this.shape_311.setTransform(314.875,41.525);

	this.shape_312 = new cjs.Shape();
	this.shape_312.graphics.f("#000000").s().p("AgiAuQgDgEAAgEIAAg5IAAgIIAAgIQAAgFAEgDQADgEAFAAQAKAAACAKQAOgLATAAQASAAAAAXIAAAGQgBANgMAAQgKAAgBgLIAAgJQgTADgIARIAAAsQgBAFgDADQgDADgFAAQgGAAgDgDg");
	this.shape_312.setTransform(306.45,41.625);

	this.shape_313 = new cjs.Shape();
	this.shape_313.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGABAPQAAAJgLAIQgFADgPAGIgdAMQAEAFAGADQAHABAHAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgIABgFAFg");
	this.shape_313.setTransform(296.8,41.55);

	this.shape_314 = new cjs.Shape();
	this.shape_314.graphics.f("#000000").s().p("AgHA9QgEgDAAgFIAAgJIABgKIgCgsIgQgBQgMgCAAgKQABgFADgDQADgEAFAAIAPABIAAgJIAAgJQAAgFADgDQAEgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAADACQAIACgBAIQAAAFgDAEQgDADgFAAIgFAAIgEAAIgIAAIABAuIAAAEIAAAFQAAAUgMAAQgFAAgDgDg");
	this.shape_314.setTransform(287.65,40.075);

	this.shape_315 = new cjs.Shape();
	this.shape_315.graphics.f("#000000").s().p("AgHA9QgDgDAAgFIAAgJIAAgKIgCgsIgQgBQgLgCAAgKQgBgFAEgDQAEgEAEAAIAQABIgBgJIAAgJQAAgFAEgDQADgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACABAIQAAAFgEAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgNAAQgDAAgEgDg");
	this.shape_315.setTransform(279.15,40.075);

	this.shape_316 = new cjs.Shape();
	this.shape_316.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAALAFQANAGgBAPQAAAJgKAIQgFADgPAGIgcAMQADAFAHADQAGABAGAAQAMAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgOAAQgTAAgOgKgAgLgUQgGAGgEAKIAVgIIASgKQgHgDgJgBQgIABgFAFg");
	this.shape_316.setTransform(269.75,41.55);

	this.shape_317 = new cjs.Shape();
	this.shape_317.graphics.f("#000000").s().p("AgIBFQgDgDAAgFIAAh5QAAgGADgDQAEgCAEAAQAGAAADACQADADAAAGIAABzQAAARgMAAQgEAAgEgDg");
	this.shape_317.setTransform(262.3,39.1);

	this.shape_318 = new cjs.Shape();
	this.shape_318.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQANAGABAPQAAAJgLAIQgFADgPAGIgdAMQAFAFAFADQAGABAIAAQALAAAIgEQAIgEAEgBQAJAAAAAJQAAALgOAGQgNAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIATgIIASgKQgFgDgKgBQgIABgFAFg");
	this.shape_318.setTransform(246.95,41.55);

	this.shape_319 = new cjs.Shape();
	this.shape_319.graphics.f("#000000").s().p("");
	this.shape_319.setTransform(237.025,39.175);

	this.shape_320 = new cjs.Shape();
	this.shape_320.graphics.f("#000000").s().p("AgHA9QgDgDAAgFIAAgJIAAgKIgCgsIgQgBQgLgCAAgKQgBgFAEgDQAEgEAFAAIAPABIgBgJIAAgJQAAgFADgDQAEgDAFAAQAMAAAAAWIAAAHIAJgBQAKAAAEACQAGACABAIQAAAFgEAEQgDADgGAAIgEAAIgEAAIgJAAIACAuIAAAEIAAAFQAAAUgNAAQgDAAgEgDg");
	this.shape_320.setTransform(227.4,40.075);

	this.shape_321 = new cjs.Shape();
	this.shape_321.graphics.f("#000000").s().p("AgdAmQgPgLAAgUQAAgVAMgQQANgRAVAAQAPAAAKAFQAOAGAAAPQAAAJgLAIQgFADgPAGIgcAMQAEAFAGADQAFABAIAAQALAAAIgEQAHgEAFgBQAJAAAAAJQAAALgPAGQgMAFgNAAQgVAAgNgKgAgLgUQgGAGgDAKIAUgIIARgKQgGgDgJgBQgHABgGAFg");
	this.shape_321.setTransform(210.2,41.55);

	this.shape_322 = new cjs.Shape();
	this.shape_322.graphics.f("#000000").s().p("AgsA4QAAgFACgDQAEgDAFAAIALACIANABQAMAAAHgIQAFgHACgRQgFAEgGACQgFADgGAAQgSAAgKgMQgLgLAAgRQAAgYAOgOQAPgQAZAAQAJAAAFACQAHACADAEQAMACAAAMIgCAQQgFAVAAAVQgBAdgJANQgLARgcAAQgjAAABgOgAgNgnQgHAJAAAOQAAALAEAFQAEAEAHAAQAHAAAHgHQAHgIABgIIAEgaIgGgDIgFgBQgPAAgIAKg");
	this.shape_322.setTransform(200.45,43.925);

	this.shape_323 = new cjs.Shape();
	this.shape_323.graphics.f("#000000").s().p("");
	this.shape_323.setTransform(191.175,41.45);

	this.shape_324 = new cjs.Shape();
	this.shape_324.graphics.f("#000000").s().p("AAVAoIgOAHQgGABgDAAQgWAAgKgLQgLgMAAgWQAAgUAQgPQAPgQAVAAQAJABALAFQANAFAAAHQAAAEgCACIgBAJIgBAMQAAAQACAHIAEAJIAEAJQAAAFgEADQgDACgFAAQgEABgJgJgAgMgRQgIAKAAALQAAAMAEAFQAEAHAIAAQAFAAAFgCQAFgCAEgEQgDgUAAgKIABgGIABgIIgDgCIgDAAQgLAAgJAJg");
	this.shape_324.setTransform(181.425,41.6);

	this.shape_325 = new cjs.Shape();
	this.shape_325.graphics.f("#000000").s().p("AgiAuQgCgEAAgEIAAg5IAAgIIAAgIQAAgFADgDQACgEAGAAQAJAAACAKQAPgLATAAQARAAAAAXIAAAGQAAANgLAAQgMAAAAgLIAAgJQgTADgJARIAAAsQABAFgEADQgDADgFAAQgGAAgDgDg");
	this.shape_325.setTransform(172.2,41.625);

	this.shape_326 = new cjs.Shape();
	this.shape_326.graphics.f("#000000").s().p("AgiAuQgCgEAAgEIAAg5IAAgIIAAgIQAAgFADgDQADgEAFAAQAKAAABAKQAPgLATAAQASAAAAAXIAAAGQgBANgLAAQgMAAAAgLIAAgJQgTADgJARIAAAsQAAAFgDADQgDADgFAAQgGAAgDgDg");
	this.shape_326.setTransform(163.55,41.625);

	this.shape_327 = new cjs.Shape();
	this.shape_327.graphics.f("#000000").s().p("AAtBCQgHAAgHgQQgFgKgDgOIgWACIgUACIgOAdQgEAHgHAAQgFAAgDgDQgEgEAAgFQAAgEANgaQgCgDABgCQAAgFAIgCIAcgsQAVghAFAAQAKAAADAMIAFAcIANA5IAFALQADAIAAAEQAAAFgEADQgDADgEAAIgBAAgAgGAIIALgBIANgBIgGgdIgSAfg");
	this.shape_327.setTransform(152.425,39.5781);
...
// stage content:
(lib.rhombus4 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(-79,353.9,1,1,0,0,0,14,42);
