...
(lib.Cherrytree = function() {
	this.initialize(img.Cherrytree);
}).prototype = p = new cjs.Bitmap();
...
(lib.CustardapplePlant = function() {
	this.initialize(img.CustardapplePlant);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,96,96);
...
(lib.Passionfruittree = function() {
	this.initialize(img.Passionfruittree);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,96,96);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.CustardapplePlant();
	this.instance.setTransform(-106,17,2.6906,2.6906);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-106,17,258.3,258.3), null);
...
(lib.Slotcopy3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.Cherrytree();
	this.instance.setTransform(-159,-39,2.2396,2.2396);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Slotcopy3, new cjs.Rectangle(-159,-39,215,215), null);
...
(lib.SquarePiece = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-102,-25,1.3875,1.3875);
...
p.nominalBounds = new cjs.Rectangle(-102,-25,133.2,133.2);
...
(lib.RoundedSquarePiece = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-97,-38,1.2917,1.2917);
...
p.nominalBounds = new cjs.Rectangle(-97,-38,124,124);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.instance = new lib.Passionfruittree();
	this.instance.setTransform(128,300,2.6906,2.6906);
...
}).prototype = getMCSymbolPrototype(lib.Slots, new cjs.Rectangle(128,294.6,869.6,264.29999999999995), null);
...
(lib.StarPiece = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-118,-34,1.6323,1.6323);
...
p.nominalBounds = new cjs.Rectangle(-118,-34,156.7,156.7);
...
}).prototype = getMCSymbolPrototype(lib.Pieces, new cjs.Rectangle(142.7,154.3,704.7,160.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Game, new cjs.Rectangle(30.3,22.3,1090.2,564.5), null);


// stage content:
(lib.tree8 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Cherrytree.png", id:"Cherrytree"},
		{src:"images/Cherry.png", id:"Cherry"},
		{src:"images/CustardapplePlant.png", id:"CustardapplePlant"},
		{src:"images/Custardapple.png", id:"Custardapple"},
		{src:"images/Passionfruittree.png", id:"Passionfruittree"},
